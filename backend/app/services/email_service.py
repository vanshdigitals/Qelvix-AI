...
def send_scan_report_email(to_email: str, org_name: str, scan_result: dict, dashboard_url: str):
    """
    Sends the scan report via email using Resend.
    """
    if not settings.resend_api_key:
        print(f"[Email Service Stub] Would have sent report to {to_email} for {org_name}")
        return

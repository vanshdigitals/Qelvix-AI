...
async def check_privacy_policy_exists(domain: str, **kwargs) -> dict:
...
async def check_contact_form_exists(domain: str, **kwargs) -> dict:
...
async def check_ssl_grade(findings: list[dict], **kwargs) -> dict:
...
async def check_no_exposed_databases(findings: list[dict], **kwargs) -> dict:
...
async def check_incident_contact_defined(**kwargs) -> dict:
...
async def check_spf_dmarc_present(findings: list[dict], **kwargs) -> dict:
...
async def evaluate_dpdp_compliance(domain: str, all_findings: list[dict], org_context: dict) -> list[dict]:
    results = []

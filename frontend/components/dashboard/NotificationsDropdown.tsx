  ...
  return (
    <div ref={containerRef} className="relative inline-block text-left">
      ...
      >
        ...
        {findings.length > 0 && (
          <span className="absolute -right-1 -top-1 flex h-4 min-w-4 items-center justify-center rounded-full bg-accent px-1 font-mono text-[10px] font-bold text-[#0B0E16]">
            {findings.length}
          </span>
        )}
      </button>
